...
def parse_single_day_expi(acc_path, date_str):
    ...
    cols = ['date', 'timestamp', 'market', 'result', 'profit_rate', 'profit_krw', 'invested_krw', 'price', 
            'PASS1_Ratio', 'fastRate', 'upRate', 'BID5_Ratio', 
            'wideTrendAvg', 'wideTrendAvg2', 'crossAvg', 'trendAvg', 'val', 'bid_price_unit', 'ask_price', 'volume']
